		...
		switch(Receive_Data[2])
		{
			case WF_ON:
			{
				if(aroma.en == OFF)
				{
					aroma.en = ON;
					#if DUAL_MODE
					aroma.timeingParameterUpdate = 1;
